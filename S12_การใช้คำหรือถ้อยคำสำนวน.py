...
# ---------------------- ตัวอย่างการเรียกใช้ ----------------------
student_answer_example =  """เห็นด้วย เพราะ ออนไลน์จะทำให้เราสะดวกมากยิ่ง
ขึ้นจะทำให้เราทำงานง่ายกว่าเดิมเละพร้อมแจ้ง
ข่าวสารได้ อย่างเช่น ทำงานออนไลน์ก็จะสะดวกกว่า
กว่าเขียนแล้ว และ สามารถหางานทางออนไลน์จะทำให้
เรามีชีวิตดีขึ้น
"""

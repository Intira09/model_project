...
# ------------------------- Run -------------------------
def evaluate_and_score(student_answer, reference_article, main_idea_keywords, example_keywords):
    results = evaluate_student_answer(
        student_answer,
        reference_article,
        main_idea_keywords,
        example_keywords
...
print(evaluate_and_score(student_answer, reference_article, main_idea_keywords, example_keywords))

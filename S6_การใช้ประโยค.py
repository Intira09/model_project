...
# ---------------- ตัวอย่างเรียกใช้ ----------------
student_answer = """การใช้สื่อสังคมออนไลน์ คนทั้วไปเรียกว่าสื่อออนไลน์หรือสื่อสังคม นั้นเป็นสื่อหรือช่องทางที่แพรข้อมูลข้าวในรูป
(แบบต่างๆการนำเสนอรดเร็ซไปยังทั่วทุกมุมโลกที่สัญณโทรศัพท์เข้าถึง)(เช่นการนำเสนอ)(ชั้นนำสินค้าพื้น)
(เมือง ให้เข้าถึงผู้ซื้อได้)ทั่วโลกการนำเสนอข้อเท็จจิงข่าวสาร(อย่างตรงไปตรงมา) การเผยแพร่งานเขียนคุณ
งานเขียนคุณกายบนโลกออนไลน์แทน(การนำสำนักพิมพ์) เช่นการนำเสนอ เราสามารถใช้สื่อสังคมออนไลน์
และหาข้อมูลข่าวสารที่มีประโยชน์ได้เป็นอย่างดีครับ"""
